...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate {
    ...
    func scrollViewDidScroll(scrollView: UIScrollView) {
        ...
        if offset < 0 {
            ...
            var alignToNameLabel = -offset + handleLabel.frame.origin.y + headerView.frame.height + offset_HeaderStop
        ...
        var segmentViewOffset = profileView.frame.height - segmentedView.frame.height - offset
